                    ...
                    <div className={styles.content}>
                        ...
                        <form action="#" onSubmit={handleCreateProduct} className={styles.form}>
                            ...
                            <div className={styles.row}>
                                <select className={styles.input} onChange={(e) => {setCategory(e.target.value);setSubcategory('')}}>
                                ...
                                {category !== '' ? (
                                    <select className={styles.input} onChange={(e) => {setSubcategory(e.target.value)}}>
