                ...
                <div className={styles.menuSm}>
                    <div className={styles.menuTrack}>
                        ...
                        <div className={styles.menuSoc}>
                            <Link href="tel:+79917617072" className={styles.menuSocLink}>+7(991)761-70-72</Link>
                            <Link href="mailto:lampastore@inbox.ru" className={styles.menuSocLink}>lampastore@inbox.ru</Link>
                            <Link href="wa.link/5z6tut" className={styles.menuSocIcon}>
            ...
            <div className={styles.top}>
                <div className={styles.topBody}>
                    <div className={styles.left}>
                        ...
                        <Link href="wa.link/5z6tut" className={styles.link}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
